...
public class TurokFrameUI<T extends Frame> extends AbstractComponentUI<Frame> {
    ...
    public static int speed_effect = 10;
    ...
    public void renderComponent(Frame component, FontRenderer fontRenderer) {
        ...
        if (component.isPinneable()) {
            if (effect) {
                ...
                if (widht >= component.getWidth()) {
                    widht  = component.getWidth();
            ...
            TurokGL.refresh_color(255, 0, 0, alpha);
            RenderHelper.drawFilledRectangle(0, 0, widht, height);
