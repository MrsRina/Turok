...
import com.oldturok.turok.util.HueCycler;
import com.oldturok.turok.util.TurokTessellator;
import com.oldturok.turok.util.TrajectoryCalculator;
...
@Module.Info(name = "Trajectories", category = Module.Category.TUROK_RENDER)
        ...
        try {
            mc.world.loadedEntityList.stream()
                ...
                if (hit != null){
                    ...
                    TurokTessellator.drawBox(hit, 0x33ffffff, GeometryMasks.FACEMAP.get(flightPath.getCollidingTarget().sideHit));
