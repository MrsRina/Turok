...
public class Module {
    ...
    {
        TUROK_COMBAT("TurokCombat", true),
        TUROK_MISC("TurokMisc", true),
        TUROK_MOVEMENT("TurokMovement", true),
        TUROK_PLAYER("TurokPlayer", true),
        TUROK_RENDER("TurokRender", true),
        TUROK_CHAT("TurokChat", true),
        TUROK_NULL("Hidden", false);
