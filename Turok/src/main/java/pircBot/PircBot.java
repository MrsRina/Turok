...
public abstract class PircBot implements ReplyConstants {
	...
	private ArrayList<TurokIRC>	lines				= new ArrayList<TurokIRC>();
	...
	public ArrayList<TurokIRC> getLines() {
		return lines;
	}

	public ArrayList<TurokIRC> getUnreadLines() {
		ArrayList<TurokIRC> ret = new ArrayList<TurokIRC>();
		for (TurokIRC ircl : lines) {
			if (!ircl.is_read()) {
				ret.add(ircl);
			}
		}
