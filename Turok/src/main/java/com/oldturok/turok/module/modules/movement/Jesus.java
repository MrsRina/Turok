...
import com.oldturok.turok.event.events.AddCollisionBoxToListEvent;
...
@Module.Info(name = "Jesus", description = "Allows you to walk on water", category = Module.Category.TUROK_MOVEMENT)
