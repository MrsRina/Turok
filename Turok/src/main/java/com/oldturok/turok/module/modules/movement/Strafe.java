...
public class Strafe extends Module {
	...
	public void onUpdate() {
		...
		if (player_forward == 0.0f && player_strafe == 0.0f) {
			...
			mc.player.motionX = ((player_forward * 0.2873f) * Math.cos(Math.toRadians((player_yaw + 90.0f))) + (player_strafe * 0.2873f) * Math.sin(Math.toRadians((player_yaw + 90.0f))));
			mc.player.motionZ = ((player_forward * 0.2873f) * Math.sin(Math.toRadians((player_yaw + 90.0f))) - (player_strafe * 0.2873f) * Math.cos(Math.toRadians((player_yaw + 90.0f))));
		}
	}
}